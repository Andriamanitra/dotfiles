# if you're reading this file this would be a good time to check if nix
# has installed completions itself, when this file was added to dotfiles
# repository it was the case that nix didn't install fish completions to
# /usr/share/fish/completions/ but that might have changed over the years
